...
class RegisterView(APIView):
    def post(self, request):
        ...
        if serializer.is_valid():
            ...
            forbidden_usernames = ["Admin", "admin", "root", "superuser"]
...
class JWTCookieTokenObtainPairView(JWTSetCookiesMixing, TokenObtainPairView):
    serializer_class = CustomTokenObtainPairSerializer


class JWTCookieTokenRefreshView(JWTSetCookiesMixing, TokenRefreshView):
